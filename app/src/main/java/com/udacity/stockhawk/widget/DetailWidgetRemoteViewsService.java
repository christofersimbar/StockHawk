    ...
    public RemoteViewsFactory onGetViewFactory(Intent intent) {
        return new RemoteViewsFactory() {
            ...
            public RemoteViews getViewAt(int position) {
                ...
                String description = data.getString(Contract.Quote.POSITION_NAME);
                ...
                views.setTextViewText(R.id.widget_change, percentageFormat.format(data.getFloat(Contract.Quote.POSITION_ABSOLUTE_CHANGE) / 100));
                ...
                Uri uriForStock = Contract.Quote.makeUriForStock(data.getString(Contract.Quote.POSITION_SYMBOL));
                fillInIntent.setData(uriForStock);
